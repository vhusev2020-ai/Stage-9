...
data class Listing(
    ...
    var packageLength: Double?,
    var packageWidth: Double?,
    var packageHeight: Double?,
    var packageType: String,
    val photos: MutableList<String>,
    val itemSpecifics: MutableMap<String, MutableList<String>> = mutableMapOf(),
    var researchRequired: Boolean = false,
    var marketResearchCheckedAt: String = "",
    var comparablePriceLow: Double? = null,
    var comparablePriceHigh: Double? = null,
    val comparableSources: MutableList<String> = mutableListOf(),
    var researchNotes: String = "",
    var publishAllowed: Boolean = true,
    var policyBlockReason: String = "",
    val policyWarnings: MutableList<String> = mutableListOf(),
